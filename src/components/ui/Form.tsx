...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Label
      ref={ref}
      className={cn('pb-0.5 text-1', error && 'text-red-900', className)}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Text
      ...
      className={cn('text-1 text-black pt-0.5', className)}
      {...props}
    />
  );
});
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <Text
      ...
      className={cn('text-0.75 font-bodylight text-red-900 pt-0.5', className)}
      {...props}>
      {body}
    </Text>
  );
